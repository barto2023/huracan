...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{route('persona.create')}}" class="">
            <button type="button" class="btn btn-primary me-md-2 pull-right">Nuevo</button>
            </a>       
        </div>
        <div class="card-body">
            <table id="tablepersonas" class= "table table-bordered table-striped table-hover">
                ...
                <TBody>
                    @foreach($personas as $persona)
                        <tr id="{{$persona->id}}">
                            ...
                            <td width="105px"> 
                                {{-- <a href="{{route('persona.edit', $persona->id)}}"> <i class="fa-solid fa-pen-to-square text-indigo"></i></a> --}}
...
@section('js')
    ...
    <script>
        let tablepersona= new DataTable('#tablepersonas',{
            language: {
        ...
        { 
            $("#tablepersonas").on("click",".eliminar", function(e){
                e.preventDefault();
