...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{route('ciudad.create')}}" class="">
            <button type="button" class="btn btn-primary me-md-2 pull-right">Nuevo</button>
            </a>
            
        </div>
        <div class="card-body">
            {{-- <table id="tablaciudads" class= "table table-bordered table-striped table-hover"> --}}
            <table id="tablaciudads" class= "table table-hover table-bordered ">
                <thead> 
                    <tr>
                        <th>ID</th>
                        <th>NOMBRE</th>
                ...
                <TBody>
                    @foreach($ciudads as $ciudad)
                        <tr id="{{$ciudad->id}}">
                            ...
                            <td> 
                                {{-- <a href="{{route('ciudad.edit', $ciudad->id)}}"> <i class="fa-solid fa-pen-to-square text-indigo"></i></a> --}}
...
@section('js')
    ...
    <script>
       ...
       let tablaciudad= new DataTable('#tablaciudads',{
            language: {
        ...
        { 
            $("#tablaciudads").on("click",".eliminar", function(e){
                e.preventDefault();
