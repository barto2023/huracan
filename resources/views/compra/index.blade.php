...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{route('compra.create')}}" class="">
            <button type="button" class="btn btn-primary me-md-2 pull-right">Nuevo</button>
            </a>       
        </div>
        <div class="card-body">
            <table id="tablecompras" class= "table table-bordered table-striped table-hover">
...
@section('js')
    ...
    <script>
        let tablecompra= new DataTable('#tablecompras',{
            language: {
        ...
        { 
            $("#tablecompras").on("click",".eliminar", function(e){
                e.preventDefault();
