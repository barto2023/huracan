...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{route('cliente.create')}}" class="">
                ...
                <TBody>
                    @foreach($clientes as $cliente)
                        <tr id="{{$cliente->id}}">
                            ...
                            <td width="115px"> 
                                {{-- <a href="{{route('cliente.edit', $cliente->id)}}"> <i class="fa-solid fa-pen-to-square text-indigo"></i></a> --}}
...
@section('js')
    ...
    <script>
        let tablecliente= new DataTable('#tableclientes',{
            language: {
        ...
        { 
            $("#tableclientes").on("click",".eliminar", function(e){
                e.preventDefault();
