                ...
                <TBody>
                    @foreach($categorias as $categoria)
                        <tr id="{{$categoria->id}}">
                            ...
                            <td> 
                                {{-- <a href="{{route('categoria.edit', $categoria->id)}}"> <i class="fa-solid fa-pen-to-square text-indigo"></i></a> --}}
...
@section('js')
    ...
    <script>
       ...
       let tablacategoria= new DataTable('#tablacategorias',{
            language: {
        ...
        { 
            $("#tablacategorias").on("click",".eliminar", function(e){
                e.preventDefault();
