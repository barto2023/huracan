...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{route('venta.create')}}" class="">
            <button type="button" class="btn btn-primary me-md-2 pull-right">Nuevo</button>
            </a>       
        </div>
        <div class="card-body">
            <table id="tableventas" class= "table table-bordered table-striped table-hover">
                ...
                <TBody>
                    @foreach($ventas as $venta)
                        <tr id="{{$venta->id}}">
                            ...
                            <td width="105px"> 
                                {{-- <a href="{{route('venta.edit', $venta->id)}}"> <i class="fa-solid fa-pen-to-square text-indigo"></i></a> --}}
...
@section('js')
    ...
    <script>
        let tableventa= new DataTable('#tableventas',{
            language: {
        ...
        { 
            $("#tableventas").on("click",".eliminar", function(e){
                e.preventDefault();
