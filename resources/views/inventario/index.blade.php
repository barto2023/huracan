...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table id="tableinventarios" class= "table table-bordered table-striped table-hover">
                ...
                <TBody>
                    @foreach($inventarios as $inventario)
                        <tr id="{{$inventario->id}}">
                            ...
                            <td width="105px"> 
                                {{-- <a href="{{route('inventario.edit', $inventario->id)}}"> <i class="fa-solid fa-pen-to-square text-indigo"></i></a> --}}
...
@section('js')
    ...
    <script>
        let tableinventario= new DataTable('#tableinventarios',{
            language: {
        ...
        { 
            $("#tableinventarios").on("click",".eliminar", function(e){
                e.preventDefault();
